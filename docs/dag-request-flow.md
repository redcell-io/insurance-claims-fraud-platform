...
| 12 | Stage 2 (`depends_on: [enrichment]`): builds the feature map (uses `claimant_id_hash`, never raw `claimant_name` — DECISIONS.md #14; also includes `address_valid`, added alongside DECISIONS.md #16) and calls Model Service | [internal/dag/executor.go](../services/orchestration-service/internal/dag/executor.go) → [client/model.go](../services/orchestration-service/internal/client/model.go) → (Go, rules-based scoring — DECISIONS.md #16) [model-service/internal/server/model.go](../services/model-service/internal/server/model.go) → [internal/scoring/scoring.go](../services/model-service/internal/scoring/scoring.go) |
